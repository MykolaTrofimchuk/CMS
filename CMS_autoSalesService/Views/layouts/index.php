...
<header class="p-3 mb-3 border-bottom">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li class="nav-item d-flex align-items-center">
                    <form action="" method="post" class="d-flex">
                        <button type="submit" class="nav-link px-2 link-secondary" name="veh_condition" value="Нове">Нові авто</button>
            ...
            <?php endif; ?>
            <?php if (\Models\Users::IsUserLogged() && \Models\Users::IsAdmin($userInfo[0]['id'])): ?>
                <a href="/adminpanel/index" class="btn btn-outline-warning me-2">&#9658;Admin panel</a></li>
            <?php endif; ?>
                ...
                <div class="dropdown text-end">
                    <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?php echo "../../../../../" . htmlspecialchars($userPhoto); ?>" alt="User" width="32"
                             height="32"
